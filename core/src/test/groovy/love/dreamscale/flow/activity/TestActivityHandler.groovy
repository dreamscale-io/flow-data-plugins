...
class TestActivityHandler extends Specification {
	...
	love.dreamscale.flow.controller.IFMController controller = Mock(love.dreamscale.flow.controller.IFMController)
	...
	void setup() {
		...
		controller.getActiveTask() >> new love.dreamscale.flow.state.TaskState(id: 1)
