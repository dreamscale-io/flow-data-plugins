package org.dreamscale.flow.state;
...
class TaskStateJsonMapperTest extends Specification {
    ...
    def "toList should deserialize deprecated troubleshooting list properties"() {
        given:
        String json = """[{"id":1,"name":"some task","description":"awesome description","project":null,"${
            deprecatedTroubleshootingListPropertyName
        }":["event1","event2"]}]"""
